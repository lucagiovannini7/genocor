...
with open('/Users/miriam/Documents/GitHub/genocor/transcripts/plain-texts/post-cleaning/RWA-Ndindabahizi-full.txt', 'r') as file:
...
for line in lines:
    ...
    line = line.replace("@THE ACCUSED:", "@EMMANUEL NDINDABAHIZI:")
...
with open('/Users/miriam/Documents/GitHub/genocor/transcripts/plain-texts/post-cleaning/RWA-Ndindabahizi-output-lawyers.txt', 'w') as file:
